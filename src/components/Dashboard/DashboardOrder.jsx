     ...
     {/* Success Modal */}
       ...
       <div className="bg-white shadow-feat p-4 h-full rounded-tr-xl rounded-br-xl">
         <div className="flex items-center justify-between">
           <h3 className="font-latrue font-semibold text-lg">
             Order {orderNumber}:{" "}
           </h3>
           <div className="font-latrue text-xs font-semibold space-x-2 flex">
         ...
         <div className="space-y-1 mt-5 mx-3">
           <h4 className="font-latrue font-semibold text-sm">Mode of Payment:</h4>
         ...
         <div className="h-[17.3rem] w-full mt-5 flex flex-col space-y-5 overflow-y-auto product-scroll px-3">
           ...
           <div className="relative grid grid-cols-[30%_1fr_35%] gap-2 items-center">
             ...
             <div className="flex flex-col justify-start">
               ...
               <span className="text-sm text-gray-500 font-latrue">
                 {product.description}
               </span>
         ...
         <div className="grid grid-rows-2 bg-gray-300/30 h-[4.5rem] -mx-4 py-2 pl-5 pr-7 gap-2 mt-3">
           <div className="flex justify-between">
             <span className="font-semibold font-latrue text-[0.9rem]">
               Number of Products:
             </span>
             <span className="font-medium font-latrue text-[0.9rem]">3x</span>
           </div>
           <div className="flex justify-between">
             <span className="font-semibold font-latrue text-[0.9rem]">
               Subtotal:
             </span>
             <span className="font-medium font-latrue text-[0.9rem]">
               &#8369; 1050
             </span>
           </div>
         </div>
         <div className="h-[3.3rem] items-center flex justify-end mt-3">
           <button
             className="text-sm font-latrue font-bold bg-[#0cd742] rounded-3xl border-[0.5px] border-green-950 py-1 text-white px-3 cursor-pointer hover:bg-black/70"
