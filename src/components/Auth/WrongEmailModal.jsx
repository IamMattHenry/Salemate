...
/**
 * Modal that appears when a user enters an email that doesn't exist in the system
 */
const WrongEmailModal = ({ isOpen, onClose, email, onSignUp }) => {
  console.log("WrongEmailModal - isOpen:", isOpen, "email:", email);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="bg-blue-500 p-6 flex justify-center items-center"
          initial={{ y: -50 }}
          animate={{ y: 0 }}
        >
          <motion.div
        ...
        <div className="p-6">
          ...
          <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-4">
            <p className="text-blue-700">
              We couldn't find an account with <span className="font-semibold">{email}</span>
            </p>
          </div>
            ...
            <div className="flex items-start">
              ...
              <div className="text-amber-700 text-sm">
                ...
                <ul className="list-disc pl-5 space-y-1">
                  <li>You've entered the correct email address</li>
                  <li>Check for typos or spelling errors</li>
                  <li>This email may not be registered yet</li>
                </ul>
              </div>
            </div>
          </div>
