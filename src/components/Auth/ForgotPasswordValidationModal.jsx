...
/**
 * A modal that appears when a user tries to reset their password without entering an email
 */
const ForgotPasswordValidationModal = ({ isOpen, onClose }) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
...
export default ForgotPasswordValidationModal;
