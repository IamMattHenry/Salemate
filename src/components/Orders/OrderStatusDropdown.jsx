    ...
    <>
      ...
      {modal && (
        <AnimatePresence>
          ...
          >
            <motion.div
              className="bg-white h-auto w-[25rem] rounded-3xl font-lato"
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 w-full mb-6 px-4">
                <div className="flex justify-start flex-col bg-stone-200/75 size-32 p-3 shadow-feat w-full">
                  <h4 className="font-bold text-[1rem] mb-3">Order(s)</h4>
                  <span className="font-normal">test</span>
                </div>
                <div className="flex justify-start flex-col bg-stone-200/75 p-3 size-32 shadow-feat w-full">
