  ...
  return (
    <section className="bg-white rounded-2xl shadow-feat w-300 mx-auto block my-4 pb-5 px-5">
        ...
        <div className="grid grid-cols-7 text-[25px] font-lato text-center justify-center bg-gray-100 w-[1145px] h-[60px] mb-2">
            ...
            <div className='pt-2'>
            <input type="" className="bg-white ml-7 border border-gray-500 text-sm text-gray-900 rounded-lg w-20 h-9" placeholder="  "/>
            </div>
            <div className='pt-2'>
            <input type="" className="bg-white ml-3 border border-gray-500 text-sm text-gray-900 rounded-lg w-20 h-9" placeholder="  "/>
            </div>
            <div className='pt-2'>
            <input type="" className="bg-white ml-1 border border-gray-500 text-sm text-gray-900 rounded-lg w-20 h-9" placeholder="  "/>
            </div>
            <div className='pt-2'>
            <input type="" className="bg-white border border-gray-500 text-sm text-gray-900 rounded-lg w-20 h-9" placeholder="  "/>
            </div>
            <div className='pt-2'>
            <input type="" className="bg-white border border-gray-500 text-sm text-gray-900 rounded-lg w-20 h-9" placeholder="  "/>
            </div>
