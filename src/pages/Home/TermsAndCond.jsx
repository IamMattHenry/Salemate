...
const TermsAndCond = () => {
  return (
    <div>
      <div className="min-w-auto md:w-10/12 flex mx-auto md:flex-row justify-between items-center px-12 min-h-10/12 -mb-2">
        <div className="flex flex-col lg:flex-col w-[50%] md:w-[40%] flex-start">
          ...
          <span className="mt-5 font-latrue text-[1.3rem] text-justify">
            These terms outline the rules for using Salemate's platform designed
            to keep things fair, transparent, and safe for everyone. By
            accessing our services, you agree to these guidelines. Please read
            this carefully. If you have questions, contact us at{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              ...
              <div className="flex gap-5 items-start pt-15 ml-10">
                <img
                  src="/terms-one.jpg"
                  alt="one"
                  className="w-30 h-30 text-black-600 flex-shrink-0"
                />
                <div className="-mt-3 ml-5">
                  <h2 className="text-2xl font-semibold font-lato text-black mb-5 -ml-3">
                  ...
                  <ul className="list-disc marker:text-2xl tracking-tight pl-5 -ml-5 pt-2 text-[18px] text-justify font-lato -mr-5">
                    ...
                    <li>
                      Keep your login details secure you’re responsible for all
              ...
              <div className="flex gap-10 items-start pt-15">
                ...
                />
                <div className="-mt-3 ml-5">
                  <h2 className="text-2xl font-semibold font-lato text-black mb-5 -ml-7">
                    2. Use of the Platform
                  </h2>
                  <div className="flex flex-col">
                  ...
                  <ul className="list-disc marker:text-2xl pl-5 pt-2 -ml-8 text-[18px] text-justify font-lato mr-5">
                    ...
                    <li>
                      Don’t misuse the platform (e.g., spam, illegal activities,
                      or harming the system).
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex gap-10 items-start">
                ...
                />
                <div className="-mt-3 ml-5">
                  <h2 className="text-2xl font-semibold font-lato text-black mb-2 -ml-7">
                    4. System Limitations
                  </h2>
                  <div className="flex flex-col">
                    <hr className="h-0.5 -ml-7 mt-1 w-83 mx-auto bg-black opacity-25 border-0 rounded-lg"></hr>
