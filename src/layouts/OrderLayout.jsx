...
const OrderLayout = () => {
  ...
  return (
    <motion.main
      className="grid min-h-screen max-w-full bg-no-repeat bg-fixed bg-gradient-to-b from-whitesm from-15% via-yellowf via-60% to-yellowsm to-90% overflow-y-hidden"
      animate={{
